 ...
 *
 * <p>
 * Covers: correct delegation to every use-case port, accurate DTO→command/query
 * mapping,
 * accurate domain-model→response mapping, and transparent exception
 * propagation. All ports are
...
class UserControllerTest {
    ...
    @Test
    @DisplayName("findUserById() builds a GetUserByIdQuery with the given id and returns the mapped response")
    ...
    @Test
    @DisplayName("findUserById() propagates UserNotFoundException when the use case cannot find the user")
    ...
    @Test
    @DisplayName("updateUser() delegates a correctly populated UpdateUserCommand and returns the mapped response")
    ...
    @Test
    @DisplayName("updateUser() propagates UserNotFoundException when the use case cannot find the user")
