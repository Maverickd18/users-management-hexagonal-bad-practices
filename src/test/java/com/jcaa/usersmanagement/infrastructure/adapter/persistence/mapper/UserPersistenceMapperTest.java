...
/**
 * Pruebas unitarias para el mapeador de persistencia de usuarios.
 * Valida la correcta transformación entre modelos de dominio, entidades de base de datos,
 * DTOs de persistencia y la extracción de datos desde un ResultSet de JDBC.
 */
