...
public final class InvalidUserEmailException extends DomainException {
  ...
  private static final String EMAIL_FORMAT_TEMPLATE = "The user email format is invalid: '%s'.";
  ...
  public static InvalidUserEmailException becauseFormatIsInvalid(final String email) {
    return new InvalidUserEmailException(String.format(EMAIL_FORMAT_TEMPLATE, email));
  }
}